...
////ADC clk 	ADC_CLKInit.AdcClockSelection=RCC_ADCPCLK2_DIV6;
////72M/6=12MHz 	HAL_RCCEx_PeriphCLKConfig(&ADC_CLKInit);
 ...
 * @retval None
 */
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc) { ADC_Hardware_Init(hadc); }
 ...
 * @retval None
 */
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc) { ADC_Hardware_DeInit(hadc); }
