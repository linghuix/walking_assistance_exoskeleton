			...
			case 1:
				switch(acc1[1]){   
				  case 0x51:
					...
					break;
				  case 0x52:
					w1[0] = ((int16_t)(acc1[3]<<8| acc1[2]));//hip flex x
					w1[1] = ((int16_t)(acc1[5]<<8| acc1[4]));//hip flex z
					w1[2] = ((int16_t)(acc1[7]<<8| acc1[6]));//hip flex y
					T = ((int16_t)(acc1[9]<<8| acc1[8]));
					flag_2 = 1;
					break;
				  case 0x53:
					angle1[0] = ((int16_t)(acc1[3]<<8| acc1[2]));//hip felx x
					angle1[1] = ((int16_t)(acc1[5]<<8| acc1[4]));//hip felx z
					angle1[2] = ((int16_t)(acc1[7]<<8| acc1[6]));//hip felx y
					T = ((int16_t)(acc1[9]<<8| acc1[8]));
					flag_3 = 1;
					break;
				}
